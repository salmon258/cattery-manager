...
export const metadata: Metadata = {
  ...
  description:
    "Cattery Management System — track cats, health, feeding, and medications.",
  ...
  other: {
    ...
    // Apple touch icon
    "apple-touch-icon": "/icons/icon@1x.png",
    // Splash screens (common iOS resolutions)
    "apple-touch-startup-image-1125x2436":
      "/splashscreens/splash-1125x2436.png",
    "apple-touch-startup-image-1242x2688":
